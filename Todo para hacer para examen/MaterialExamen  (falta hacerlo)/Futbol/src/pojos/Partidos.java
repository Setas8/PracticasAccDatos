...
public class Partidos  implements java.io.Serializable {
    ...
    public String toString() {
        return "Partidos{" + "codPartido=" + codPartido + ", jornada=" + jornada + ", golLocal=" + golLocal + ", golVisitante=" + golVisitante + '}';
    }

    public String mostrarPartidos() {
        
        return "\nJornada: " + jornada + "\n" + equiposByCodLocal.getNombre() + "->" + golLocal + "\n" + equiposByCodVisitante.getNombre()+ "->" + golVisitante;
    }
